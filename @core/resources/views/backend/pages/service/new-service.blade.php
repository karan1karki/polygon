                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">{{__('New Course')}}</h4>
                            <a href="{{route('admin.services')}}" class="btn btn-primary">{{__('All Courses')}}</a>
                        </div>
                        ...
                        <form action="{{route('admin.services')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="info-text">{{__('it will show in home pages course item short details.')}}</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <span class="info-text">{{__('if you set order for it, all course will show in frontend as a per this order')}}</span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="{{__('Select Course Image')}}" data-modaltitle="{{__('Upload Course Image')}}" data-toggle="modal" data-target="#media_upload_modal">
                                        {{__('Upload Image')}}
                                    </button>
                                </div>
                            ...
                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">{{__('Add Course')}}</button>
                        </form>
                    </div>
                </div>
            </div>
