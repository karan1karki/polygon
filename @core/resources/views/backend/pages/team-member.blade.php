                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.team.member')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control"  id="position"  name="position" placeholder="{{__('Position')}}">
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form action="#" id="team_member_edit_modal_form"  method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_position">{{__('Position')}}</label>
                            <input type="number" class="form-control"  id="edit_position"  name="position" placeholder="{{__('Position')}}">
                        </div>
                        <div class="form-group">
