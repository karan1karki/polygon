                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title">{{__('New Activity')}}</h4>
                            <a href="{{route('admin.work')}}" class="btn btn-primary">{{__('All Activities')}}</a>
                        </div>
                        <form action="{{route('admin.work')}}" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">{{__('Add New Activity')}}</button>
                        </form>
                    </div>
                </div>
            </div>
