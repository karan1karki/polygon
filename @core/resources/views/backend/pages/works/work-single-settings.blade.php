...
@section('site-title')
    {{__('Activity Single Page Settings')}}
@endsection
@section('content')
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{__('Activity Single Page Settings')}}</h4>
                                ...
                                @foreach(get_all_language() as $key => $lang)
                                    <div class="tab-pane fade @if($key == 0) show active @endif" id="tab_{{$key}}" role="tabpanel" >
                                        <div class="form-group">
                                            <label for="case_study_{{$lang->slug}}_read_more_text">{{__('Activity Read More Button Text')}}</label>
                                        ...
                                        <div class="form-group">
                                            <label for="case_study_{{$lang->slug}}_related_title">{{__('Related Activity Title')}}</label>
                                        ...
                                        <div class="form-group">
                                            <label for="case_study_{{$lang->slug}}_gallery_title">{{__('Activity Gallery Title')}}</label>
