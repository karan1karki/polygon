                    ...
                    ">
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/services')}}"><a
                                    href="{{route('admin.services')}}">{{__('All Courses')}}</a></li>
                            <li class="{{active_menu('admin-home/services/new')}}"><a
                                    href="{{route('admin.services.new')}}">{{__('New Course')}}</a></li>
                            ...
                            <li class="{{active_menu('admin-home/services/page-settings')}}"><a
                                    href="{{route('admin.services.page.settings')}}">{{__('Course Page')}}</a></li>
                            <li class="{{active_menu('admin-home/services/single-page-settings')}}"><a
                                    href="{{route('admin.services.single.page.settings')}}">{{__('Course Single Page')}}</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    @if(request()->is(['admin-home/works/*','admin-home/works'])) active @endif ">
                        ...
                        <ul class="collapse">
                            <li class="{{active_menu('admin-home/works')}}"><a
                                        href="{{route('admin.work')}}">{{__('All Activity')}}</a></li>
                            <li class="{{active_menu('admin-home/works/new')}}"><a
                                    href="{{route('admin.work.new')}}">{{__('New Activity')}}</a></li>
                            ...
                            <li class="{{active_menu('admin-home/works/single-page/settings')}}"><a
                                    href="{{route('admin.work.single.page.settings')}}">{{__('Activity Single Page Settings')}}</a></li>
                        </ul>
                    </li>
                    @endif
