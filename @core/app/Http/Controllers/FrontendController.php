...
class FrontendController extends Controller
{
    ...
    public function index()
    {
        ...
        $all_team_members = TeamMember::where('lang', $lang)->orderBy('id', 'asc')->take(get_static_option('home_page_01_team_member_items'))->get();
    ...
    public function about_page()
    {
        ...
        $lang = !empty(session()->get('lang')) ? session()->get('lang') : $default_lang->slug;
        $all_brand_logo = Brand::all();
        $all_team_members = TeamMember::where('lang', $lang)->orderBy('position', 'asc')->take(get_static_option('about_page_team_member_item'))->get();
    ...
    public function team_page()
    {
        $default_lang = Language::where('default', 1)->first();
        $lang = !empty(session()->get('lang')) ? session()->get('lang') : $default_lang->slug;
        $all_team_members = TeamMember::where('lang', $lang)->orderBy('position', 'asc')->paginate(12);
