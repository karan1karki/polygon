                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title"><?php echo e(__('New Activity')); ?></h4>
                            <a href="<?php echo e(route('admin.work')); ?>" class="btn btn-primary"><?php echo e(__('All Activities')); ?></a>
                        </div>
                        <form action="<?php echo e(route('admin.work')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add New Activity')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/polygonedu/public_html/test/@core/resources/views/backend/pages/works/new-work.blade.php ENDPATH**/ ?>