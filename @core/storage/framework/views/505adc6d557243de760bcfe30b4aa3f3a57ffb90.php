                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <h4 class="header-title"><?php echo e(__('New Course')); ?></h4>
                            <a href="<?php echo e(route('admin.services')); ?>" class="btn btn-primary"><?php echo e(__('All Courses')); ?></a>
                        </div>
                        ...
                        <form action="<?php echo e(route('admin.services')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <small class="info-text"><?php echo e(__('it will show in home pages course item short details.')); ?></small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <span class="info-text"><?php echo e(__('if you set order for it, all course will show in frontend as a per this order')); ?></span>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="media-upload-btn-wrapper">
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn" data-btntitle="<?php echo e(__('Select Course Image')); ?>" data-modaltitle="<?php echo e(__('Upload Course Image')); ?>" data-toggle="modal" data-target="#media_upload_modal">
                            ...
                            <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add Course')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/polygonedu/public_html/test/@core/resources/views/backend/pages/service/new-service.blade.php ENDPATH**/ ?>