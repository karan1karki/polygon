<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('Activity Single Page Settings')); ?>
    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-t">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Activity Single Page Settings')); ?></h4>
                                ...
                                <?php $__currentLoopData = get_all_language(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tab-pane fade <?php if($key == 0): ?> show active <?php endif; ?>" id="tab_<?php echo e($key); ?>" role="tabpanel" >
                                        <div class="form-group">
                                            <label for="case_study_<?php echo e($lang->slug); ?>_read_more_text"><?php echo e(__('Activity Read More Button Text')); ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="case_study_<?php echo e($lang->slug); ?>_related_title"><?php echo e(__('Related Activity Title')); ?></label>
                                        ...
                                        <div class="form-group">
                                            <label for="case_study_<?php echo e($lang->slug); ?>_gallery_title"><?php echo e(__('Activity Gallery Title')); ?></label>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/polygonedu/public_html/test/@core/resources/views/backend/pages/works/work-single-settings.blade.php ENDPATH**/ ?>