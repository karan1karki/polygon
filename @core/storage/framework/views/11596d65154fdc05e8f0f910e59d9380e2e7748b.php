                        ...
                        <ul>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    ...
                                    $service_cat_id = !empty($service_item->category) ? $service_item->category->id : '';
                                    ?>
                                    <a href="<?php echo e(URL::asset('assets/pdf/Course_Details.zip')); ?>" class="service-widget">
                                        <div class="service-title">
                                            <h6 class="title">Click To Download Course Contents</h6>
                                        </div></a>
                                </li>
                        </ul>
                    </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/polygonedu/public_html/@core/resources/views/frontend/pages/service/service-single.blade.php ENDPATH**/ ?>