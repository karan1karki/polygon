    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('Course Items')); ?></h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a tabindex="0" class="btn btn-lg btn-danger btn-xs mb-3 mr-1"
                                                       ...
                                                       title=""
                                                       data-content="
                                               <h6><?php echo e(__('Are you sure to delete this course item ?')); ?></h6>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home3/polygonedu/public_html/test/@core/resources/views/backend/pages/service/index.blade.php ENDPATH**/ ?>