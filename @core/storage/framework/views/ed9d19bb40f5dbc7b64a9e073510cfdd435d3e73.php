                ...
                <ul class="metismenu" id="menu">
                    ...
                    ">
                        <a href="javascript:void(0)"
                           aria-expanded="true">
                            <i class="ti-layout"></i>
                            <span><?php echo e(__('Courses')); ?></span>
                        </a>
                        <ul class="collapse">
                            <li class="<?php echo e(active_menu('admin-home/services')); ?>"><a
                                    href="<?php echo e(route('admin.services')); ?>"><?php echo e(__('All Courses')); ?></a></li>
                            <li class="<?php echo e(active_menu('admin-home/services/new')); ?>"><a
                                    href="<?php echo e(route('admin.services.new')); ?>"><?php echo e(__('New Course')); ?></a></li>
                            ...
                            <li class="<?php echo e(active_menu('admin-home/services/page-settings')); ?>"><a
                                    href="<?php echo e(route('admin.services.page.settings')); ?>"><?php echo e(__('Course Page')); ?></a></li>
                            <li class="<?php echo e(active_menu('admin-home/services/single-page-settings')); ?>"><a
                                    href="<?php echo e(route('admin.services.single.page.settings')); ?>"><?php echo e(__('Course Single Page')); ?></a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
                    ...
                    <?php if(request()->is(['admin-home/works/*','admin-home/works'])): ?> active <?php endif; ?> ">
                        ...
                        <ul class="collapse">
                            <li class="<?php echo e(active_menu('admin-home/works')); ?>"><a
                                        href="<?php echo e(route('admin.work')); ?>"><?php echo e(__('All Activity')); ?></a></li>
                            <li class="<?php echo e(active_menu('admin-home/works/new')); ?>"><a
                                    href="<?php echo e(route('admin.work.new')); ?>"><?php echo e(__('New Activity')); ?></a></li>
                            ...
                            <li class="<?php echo e(active_menu('admin-home/works/single-page/settings')); ?>"><a
                                    href="<?php echo e(route('admin.work.single.page.settings')); ?>"><?php echo e(__('Activity Single Page Settings')); ?></a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
...
<?php /**PATH /home3/polygonedu/public_html/test/@core/resources/views/backend/partials/sidebar.blade.php ENDPATH**/ ?>