                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.team.member')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="position"><?php echo e(__('Position')); ?></label>
                                <input type="number" class="form-control"  id="position"  name="position" placeholder="<?php echo e(__('Position')); ?>">
                            </div>
                            <div class="form-group">
            ...
            <div class="modal-content">
                ...
                <form action="#" id="team_member_edit_modal_form"  method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="edit_position"><?php echo e(__('Position')); ?></label>
                            <input type="number" class="form-control"  id="edit_position"  name="position" placeholder="<?php echo e(__('Position')); ?>">
                        </div>
                        <div class="form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','.team_member_edit_btn',function(){
                ...
                form.find('#edit_position').val(position);
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\polygoneserver\@core\resources\views/backend/pages/team-member.blade.php ENDPATH**/ ?>